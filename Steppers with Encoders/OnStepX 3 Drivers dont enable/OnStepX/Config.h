...
#define AXIS3_SENSE_HOME              OFF //  HIGH  OFF, HIGH or LOW enables & state clockwise home position, as seen from above. Option
//#define AXIS3_SENSE_HOME_PIN           13 //
//#define SLEW_HOME_REFINE_TIME_LIMIT   300 //    120 is default

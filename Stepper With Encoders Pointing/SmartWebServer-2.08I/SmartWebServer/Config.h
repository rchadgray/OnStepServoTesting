...
#define AXIS1_ENCODER                  AB //    OFF, AB, AB_ESP32, CW_CCW, PULSE_DIR, AS37_H39B_B. RA/Azm (A/MA) & (B/SLO.)   Option
#define AXIS1_ENCODER_TICKS_DEG   8500.08 // 22.222, n, (ticks/degree.) Encoder ticks per degree.                             Adjust
...
#define AXIS2_ENCODER                  AB //    OFF, AB, AB_ESP32, CW_CCW, PULSE_DIR, AS37_H39B_B. Dec/Alt (A/MA) & (B/SLO.)  Option
#define AXIS2_ENCODER_TICKS_DEG   8500.08 // 22.222, n, (ticks/degree.) Encoder ticks per degree.                             Adjust

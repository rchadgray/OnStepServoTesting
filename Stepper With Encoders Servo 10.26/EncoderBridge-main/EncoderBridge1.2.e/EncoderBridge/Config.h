...
#define SERIAL_BAUD                921200 // 460800, Or use 921600,460800,230400,115200,etc.                                  Option
...
#define AXIS2_ENCODER                  AB //    OFF, AB, CW_CCW, PULSE_DIR, etc.         Dec/Alt Axis (A/MA) & (B/SLO.)       Option
